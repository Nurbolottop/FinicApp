...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        hadiths_data = [
            {
                "text": "Действия оцениваются только по намерениям, и каждый человек получит то, что он намеревался сделать.",
                "source": "Сахих аль-Бухари",
            },
            {
                "text": "Тот, кто не проявляет милосердия к людям, тот не получит милосердия от Аллаха.",
                "source": "Сахих Муслим",
            },
            {
                "text": "Лучший из вас — тот, кто наиболее полезен другим.",
                "source": "Ас-Суюти",
            },
            {
                "text": "Милосердие не нисходит на сердце, в котором есть гордыня.",
                "source": "Муснад Ахмада",
            },
            {
                "text": "Кормите голодных, посещайте больных и освобождайте пленников.",
                "source": "Сахих аль-Бухари",
            },
        ]
